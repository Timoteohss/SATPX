...
aurcheck packer i3-gaps vim-pathogen tamzen-font-git unclutter-xfixes-git urxvt-resize-font-git polybar python-pywal xfce-theme-blackbird fzf-git spotify || red Erro na instalação dos pacotes AUR...
